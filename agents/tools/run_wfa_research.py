...
def main():
    ...
    # ----------------------------------------------------
    print("\n=== PHASE 1: IN-SAMPLE SEARCH (BTCUSDT 15m, 2026-03-01 to 2026-04-20) ===")
    ...
    # ----------------------------------------------------
    print("\n=== PHASE 2: VALIDATION (BTCUSDT 15m, 2026-04-20 to 2026-05-15) ===")
    ...
    # ----------------------------------------------------
    print("\n=== PHASE 3: OUT-OF-SAMPLE & STRESS (BTCUSDT 15m, 2026-05-15 to 2026-06-01) ===")
